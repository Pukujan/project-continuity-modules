...
- Boundary disclosures: single authenticated identity (the owner account) — acceptable because the [owner decision 5816655372](https://github.com/Pukujan/project-continuity-modules/issues/53#issuecomment-5816655372) removed the second-account requirement; one Actions-budget refusal in the private phase was resolved by making the trial repository public (jobs then ran); trial product code is synthetic and was never mixed into PCM. Issue closeout was reconciled on the trial itself: [trial issue #1](https://github.com/Pukujan/pcm-dogfood-0024-lifecycle/issues/1) closed 2026-09-25 with a closeout comment recording both merges, the refusal behavior, and the worktree removal; repository deletion is deferred until #53 records this evidence.
