...
The readable structure for issue logs, progress updates and pull requests is the separately versioned `issue-log-format` module (policy 1.2.0): docs/ISSUE_LOG_FORMAT.md.
