...
task is merged, complete, and clean. Pin an intentional exception with
`git worktree lock --reason "<reason>" <path>`; unlock it explicitly before
verified cleanup. Choose `--workspace-mode single-checkout`
