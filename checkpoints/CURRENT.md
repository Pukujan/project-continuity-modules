...
The preceding PCM-0018 staging sentence is superseded: implementation PR #51 merged automatically at `98747fce4d5c805670dc3b00bb572e5c02706237`, all required hosted checks passed, and the permanent checkout is now clean on `main` at that commit. The 0.3.0 implementation is merged but not published. Issue #33 remains open because neither the baseline nor candidate fresh-session report is durably recorded; the earlier unsupported baseline claim is not accepted as evidence.
