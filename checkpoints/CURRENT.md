...
## Current projection — PCM-0047 delivered/closed; PCM-0046 merged, arms awaiting provider rate window; decisions queued

Program state 2026-09-25 ~21:20Z: **PCM-0047 (#140) delivered and CLOSED** — sanitizer + same-commit index refresh on main at `68765dd` (#147), closeout `1a64864` (#149), marker `626be9d` (#150); receipts 5839201831/5839204142/5839204375; worktree removed. **PCM-0046 (#139)**: deterministic scorer + 42 tests + fixtures + rubric MERGED at `09638d8` (#148), merge receipt 5839360783; the 20 hidden arms are blocked by a provider 429 window (probe 21:15Z: retry-after ~7.2h, opens ~04:15Z 2026-09-26); launcher + rescoring harness persisted via #151 (docs/plans/PCM-0046-arm-*). **PCM-0050 (#144)**: research + prior-art remediation merged (#145 #146); owner decision brief 5839017899 pending. **PCM-0048 (#142) / PCM-0049 (#143)**: owner A/B decision briefs 5839021694 / 5839021912 pending.
...
1) Run the PCM-0046 holdout per docs/plans/PCM-0046-arm-plan.md INCLUDING its 2026-09-25 amendments 1-10 (v1 prompts/bundles void; Amendment 4). Procedure: `python3.12 docs/plans/PCM-0046-arm-bundles.py` stages isolated roots at /tmp/pcm0046-arms-v2 (guidance committed at docs/plans/PCM-0046-guidance-candidate.md / -baseline.md; per-arm manifest written). ALL arms launch after the provider window: the scout model (yolo-auto/yolo-small) shares the same rate pool — 15 text-arm launches at ~22:05Z all failed 429 pre-execution (retry-after ~6.85h, opens ~05:00Z 2026-09-26); zero arms have run, bundles verified unmodified. TEXT arms (T2-1..5, T3-1..5, T3b-1..5) on read-only scout; WRITE arms (T1-1..5, T1b-1..5, T4-1..5) on write-capable task subagents. Parent stores T2/T3/T3b texts as /tmp/pcm0046-arms/results/T2-<n>.answer.txt / T3-<n>.message.txt / T3b-<n>.message.txt, then `python3.12 docs/plans/PCM-0046-arm-scorer.py capture /tmp/pcm0046-arms-v2 /tmp/pcm0046-arms/results` and `score /tmp/pcm0046-arms/results`. T3 is scored intent=True (Amendment 10: prompt states closing intent; keyword hits -> inconclusive, never fail). Verify canonical `git status --porcelain` empty and record it. Report candidate+baseline tallies on #139, append to #137; PCM-0046 checkpoint + closeout PR; close #139; `continuity worktree remove PCM-0046`. 2) PCM-0051 (#154): after this release merges, TDD-widen CLOSING_DIRECTIVE_RE (colon `Closes: #N`, cross-repo `Fixes org/repo#N`) red-first on task/PCM-0051-sanitizer-forms. 3) Owner decisions pending: #144 Q1-Q5 (brief 5839017899), #142 A/B (5839021694), #143 A/B (5839021912) — no SPEC/AGENTS/cli edits before answers.
