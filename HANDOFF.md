...
Use the canonical task [tasks/TASK-PCM-0018-document-discovery.md](tasks/TASK-PCM-0018-document-discovery.md) and `checkpoints/CURRENT.md`. Run the task's same visible prompt in two independent fresh sessions, pinned to baseline `85f13464c466ff277ce319850ce8124c4bc95c52` and merged candidate `98747fce4d5c805670dc3b00bb572e5c02706237`; keep prior-run results and diagnosis out of both prompts. Record the actual reports, objective rubric checks, elapsed time, and cleanup. Keep issue #33 open until all acceptance is evidenced and a separate merged closeout records final task/checkpoint/handoff state. Leave issues #15 and #42 open for their explicit scope constraints; do not modify excluded target repositories or search/generate the images.
